...
const evenNumbers = mixedNumbers.filter(element => element % 2 === 0)                   // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
const postTaxPrices = prices.map(function(num, ind, arr){
  return postTaxPrices = prices * 0.07
